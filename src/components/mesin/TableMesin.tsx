...
import { DeleteMesinDialog } from './DeleteMesinDialog';
import { AddMesinDialog } from './AddMesinDialog';
import { EditMesinDialog } from './EditMesinDialog';
import { PayloadDeviceType } from '../../types/typeDevice';
import { getPaginateDevice } from '../../service/deviceService';
...
const TableMesin = () => {
  ...
  const [currentSelected, setCurrentSelected] = useState<PayloadDeviceType>({
    id_mesin: '',
    nama_dinas: '',
    nama_stasiun: '',
    id: 0,
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['device', offset],
    queryFn: () => getPaginateDevice({ limit: 10, offset, token: token || '' }),
  });
