...
import {
  PayloadStationServiceType,
  PayloadStationType,
} from '../../types/typeStation';
import { addStationService } from '../../service/stationService';
...
export const AddStationDialog = ({ isOpen, handleOpen }: PropAddTypeDialog) => {
  ...
  const muttation = useMutation({
    mutationFn: (payload: PayloadStationServiceType) =>
      addStationService(payload),
    mutationKey: ['station'],
    onSuccess: (data) => {
                  ...
                  render={({ field }) => {
                    return (
                      <Select
                        ...
                        options={
                          provinces?.data
                            ? provinces?.data.map((val: TypeOptionProv) => ({
                  ...
                  render={({ field }) => {
                    return (
                      <Select
                        ...
                        options={
                          cities?.data
                            ? cities?.data.map((val: TypeOptionCity) => ({
                                label: val.city_name,
                                value: val.id,
                              }))
                            : []
